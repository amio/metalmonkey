            ...
            <li className='option-group'>
              ...
              <div className='group-content'>
                <div className='option'>
                  ...
                  <label><input name='editor-font-size' type='radio' />SMALL</label>
                  <label><input name='editor-font-size' type='radio' defaultChecked />MEDIUM</label>
                  <label><input name='editor-font-size' type='radio' />LARGE</label>
                </div>
              </div>
            </li>
            <li className='option-group'>
